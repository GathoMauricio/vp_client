...
<div class="container">
    ...
    <div class="row shadow p-3 mb-5 bg-white rounded">
        <div class="container">
            <form action="{{ route('store_final_user') }}" class="form" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            @endif
                            <input name="area_descripcion" value="{{ old('area_descripcion') }}" type="text" class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="asentamiento" value="{{ old('asentamiento') }}" id="cbo_asentamiento_sepomex" type="text" class="form-control">
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="ciudad" value="{{ old('ciudad') }}" id="txt_ciudad_sepomex" type="text" class="form-control" readonly>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <button  type="submit" class="btn btn-primary float-right">Agregar usuario final</button>
                        </div>
                    </div>
                </div>
            </form>
